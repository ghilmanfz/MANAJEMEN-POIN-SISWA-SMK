    ...
    <ul class="nav side-menu">
      ...
      <li><a><i class="fa fa-sitemap"></i> Master Data <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            ...
            <li><a href="main.php?module=perbaikan"><i class="fa fa-star-o"></i> perbaikan</a>
            </li>
...
<div class="menu_section">
  <h3>Pembinaan Karakter</h3>
    <ul class="nav side-menu">
      ...
      <li><a href="main.php?module=input_perbaikan_siswa"><i class="fa fa-pencil-square-o"></i> Input Perbaikan Siswa </a>
      </li>
      <li><a><i class="fa fa-newspaper-o"></i> Laporan <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          ...
          <li><a href="main.php?module=laporan_perbaikan">Laporan Perbaikan</a></li>
        </ul>
      </li>
