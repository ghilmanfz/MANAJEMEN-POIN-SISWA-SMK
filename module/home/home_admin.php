          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Grafik perbaikan Siswa <small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <h2><small><?php echo $tahun1; ?></small></h2>
                    </ul>
                    <div class="clearfix"></div>
                  ...
                  <div class="x_content">
                    <div id="grafik_perbaikan1" style="width:100%; height:230px;"></div>
                  </div>
                </div>
              </div>
              <!-- /bar charts -->
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="grafik_perbaikan2" style="width:100%; height:230px;"></div>
                  </div>
                </div>
              </div>
              <!-- /bar charts -->
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="grafik_perbaikan3" style="width:100%; height:230px;"></div>
                  </div>
                </div>
              </div>
              <!-- /bar charts -->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          ...
                          <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">perbaikan</a>
                          </li>
                        </ul>
                            ...
                            <table class="data table table-striped no-margin table-bordered">
                              ...
                              <tbody>
                                 <?php 
                                    ...
                                    $detail_poin = mysqli_query($connect,"SELECT * FROM detail_poin JOIN siswa ON siswa.nis=detail_poin.nis JOIN perbaikan ON detail_poin.id_perbaikan=perbaikan.id_perbaikan JOIN kelas ON siswa.id_kelas=kelas.id_kelas JOIN jurusan ON kelas.id_jurusan=jurusan.id_jurusan ORDER BY detail_poin.tanggal DESC LIMIT 10");
                                    $no=1;
                                    while($dp=mysqli_fetch_array($detail_poin)){
