...
elseif ($_SESSION['akses']==5){ ?>
 			...
 			<?php
                ...
                $perbaikan=mysqli_query($connect, "SELECT SUM(perbaikan.poin) AS totperbaikan FROM perbaikan JOIN detail_poin ON perbaikan.id_perbaikan=detail_poin.id_perbaikan WHERE detail_poin.nis='$nis' ORDER BY detail_poin.nis");
				$pres=mysqli_fetch_array($perbaikan);
                $poinperbaikan=$pres['totperbaikan'];
...
<div class="right_col" role="main">
	<div class="">
        <div class="row top_tiles">
            ...
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  <div class="icon"><i class="fa fa-star-o"></i></div>
                  <div class="count"><?php if($poinperbaikan==0){echo "0";} else{ echo $poinperbaikan; }?></div>
                  <h3>Poin perbaikan </h3>
                  <p>Total poin perbaikan yang didapat</p>
                </div>
            </div>
        </div>
    </div><!-- Penutup class "" -->
    ...
    <h4 align="center">Anda dapat melakukan pengecekan detail poin pelanggaran, prestasi dan perbaikan dengan klik menu di samping atau klik tombol di bawah ini</h4>
    <br>
    <div class="col-md-3"></div>
    <div class="col-md-4">
    	<a href="main.php?module=lap_pelanggaran_ke_siswa">
        <button class="btn btn-primary">Cek Poin Pelanggaran</button>
    ...
    <div class="col-md-4">
    	<a href="main.php?module=lap_perbaikan_ke_siswa">
    		<button type="button" class="btn btn-primary btn-lg">Cek Poin perbaikan</button>
    	</a>
    </div>
