          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3> Edit Data perbaikan Siswa<small></small></h3>
              </div>
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Edit Data perbaikan</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="module/perbaikan_siswa/aksi_edit.php" method="post">
                      <?php
                        $idDetailPoin=$_GET['id_detail_poin'];

                        $perbaikan=mysqli_query($connect, "SELECT * FROM detail_poin JOIN siswa ON detail_poin.nis=siswa.nis JOIN perbaikan ON detail_poin.id_perbaikan=perbaikan.id_perbaikan WHERE id_detail_poin='$idDetailPoin'");
                        $pres=mysqli_fetch_array($perbaikan);
                        $nis=$pres['nis'];
                        $namaSiswa=$pres['nama_siswa'];
                        $idperbaikan=$pres['id_perbaikan'];
                        $namaperbaikan=$pres['nama_perbaikan'];
                      ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="<?php echo $idperbaikan." - ".$namaperbaikan; ?>" type="text" name="perbaikan" id="autocomplete-perbaikan" class="form-control col-md-10" style="float: left;" />
                          <div id="autocomplete-container" style="position: relative; float: left; width: 400px; margin: 10px;"></div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="reset" class="btn btn-primary" onclick="window.location='main.php?module=input_perbaikan_siswa'">Cancel</button>
