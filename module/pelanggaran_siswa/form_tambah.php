                    ...
                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="main.php?module=detail_siswa&nis=<?php echo $plg['nis'];?>&sb=input_pelanggaran"><?php echo $plg['ket']; ?></a></td>
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <a href="module/pelanggaran_siswa/aksi_hapus.php?id_detail_poin=<?php echo $idDetailPoin;?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger btn-sm"><i class='fa fa-trash'></i></button></a>
                            </div>
                          </td>
                        </tr>
