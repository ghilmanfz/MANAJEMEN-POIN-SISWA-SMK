                    ...
                    <div class="col-md-3 col-sm-3 col-xs-3 profile_left">
                      ...
                      <br />
                                <?php
                                   ...
                                   $query_perbaikan=mysqli_query($connect, "SELECT detail_poin.id_detail_poin, detail_poin.tanggal, perbaikan.nama_perbaikan, detail_poin.ket, SUM(perbaikan.poin) AS jml_perbaikan FROM detail_poin JOIN siswa ON detail_poin.nis=siswa.nis JOIN perbaikan ON detail_poin.id_perbaikan=perbaikan.id_perbaikan WHERE detail_poin.nis='$nis' ");
                                   $hitung_perb=mysqli_fetch_array($query_perbaikan);
                                   $poin_perb=$hitung_perb['jml_perbaikan'];
                                   $persen_perb=$poin_perb/125*100;
                                 ?>
                      ...
                      <ul class="list-unstyled user_data">
                        ...
                        <li>
                          <p>Perbaikan<?php echo " [ ".$poin_perb." ] "; ?></p>
                          <div class="progress progress_sm">
                            <div class="progress-bar bg-green" role="progressbar" data-transitiongoal="<?php echo $persen_perb; ?>"></div>
                          </div>
                        </li>
                        <li>
