    ...
    <div class="container body">
      <div class="main_container">
        ...
        elseif ($_GET['module'] == 'perbaikan') {
          include "module/perbaikan/tampil_perbaikan.php";
        }elseif ($_GET['module'] == 'tambah_perbaikan') {
                include "module/perbaikan/form_tambah.php";
        }elseif ($_GET['module'] == 'edit_perbaikan') {
                include "module/perbaikan/form_edit.php";
        }
        ...
        elseif ($_GET['module'] == 'input_perbaikan_siswa') {
          include "module/perbaikan_siswa/form_tambah.php";
        }elseif ($_GET['module'] == 'edit_perbaikan_siswa') {
          include "module/perbaikan_siswa/form_edit.php";
        }
        ...
        elseif ($_GET['module'] == 'laporan_perbaikan') {
                include "module/laporan_perbaikan/tampil_laporan_perbaikan.php";
        }elseif ($_GET['module'] == 'detail_perbaikan_siswa') {
                include "module/laporan_perbaikan/tampil_detail.php";
        }elseif ($_GET['module'] == 'lap_perbaikan_ke_siswa') {
                include "module/laporan_perbaikan/laporan_ke_siswa.php";
        }
        ...
        <footer>
          <div class="pull-right">
            Sistem Pembinaan Karakter Siswa - SMK AL-HASRA&copy;2024
            GhilmanFZ
          </div>
          <div class="clearfix"></div>
        </footer>
...
<script>
  $(document).ready(function() {
    <?php
    include "lib/koneksi.php";
    //get matched data from guru table
...
<script>
  $(document).ready(function() {
    <?php
    include "lib/koneksi.php";
    //get matched data from orang_tua table
...
<script>
  $(document).ready(function() {
    <?php
    include "lib/koneksi.php";
    //get matched data from siswa table
...
<script>
  $(document).ready(function() {
    <?php
    include "lib/koneksi.php";
    //get matched data from pelanggaran table with joins
...
<script>
  $(document).ready(function() {
    <?php
    include "lib/koneksi.php";
    //get matched data from prestasi table
...
<script>
  $(document).ready(function() {
    <?php
    include "lib/koneksi.php";
    //get matched data from perbaikan table
    $query = $connect->query("SELECT id_perbaikan, nama_perbaikan FROM perbaikan");
    ?>

    var perbaikan = {
      <?php while($row = mysqli_fetch_array($query)){
        echo '"' . $row['id_perbaikan'] . '":"' . $row['id_perbaikan'] . ' - ' . $row['nama_perbaikan'] . '",';
      } ?>
    };

    var perbaikanArray = $.map(perbaikan, function(value, key) {
      return {
        value: value,
        data: key
      };
    ...
    // initialize autocomplete with custom appendTo
    $('#autocomplete-perbaikan').autocomplete({
      lookup: perbaikanArray,
      appendTo: '#autocomplete-container'
    });
  });
</script>
<!-- /Autocomplete perbaikan -->
    ...
    <script>
      $(document).ready(function() {
        ...
        <?php
          $presJan=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=1 GROUP BY MONTH(tanggal)");
          $presFeb=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=2 GROUP BY MONTH(tanggal)");
          $presMar=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=3 GROUP BY MONTH(tanggal)");
          $presApr=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=4 GROUP BY MONTH(tanggal)");
          $presMei=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=5 GROUP BY MONTH(tanggal)");
          $presJun=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=6 GROUP BY MONTH(tanggal)");
          $presJul=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=7 GROUP BY MONTH(tanggal)");
          $presAgu=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=8 GROUP BY MONTH(tanggal)");
          $presSep=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=9 GROUP BY MONTH(tanggal)");
          $presOkt=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=10 GROUP BY MONTH(tanggal)");
          $presNov=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=11 GROUP BY MONTH(tanggal)");
          $presDes=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=12 GROUP BY MONTH(tanggal)");

        ?>
        Morris.Bar({
          element: 'grafik_perbaikan1',
          data: [
        ...
        <?php
          $presJan2=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun2' AND MONTH(tanggal)=1 GROUP BY MONTH(tanggal)");
          $presFeb2=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun2' AND MONTH(tanggal)=2 GROUP BY MONTH(tanggal)");
          $presMar2=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun2' AND MONTH(tanggal)=3 GROUP BY MONTH(tanggal)");
          $presApr2=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun' AND MONTH(tanggal)=4 GROUP BY MONTH(tanggal)");
          $presMei2=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun2' AND MONTH(tanggal)=5 GROUP BY MONTH(tanggal)");
          $presJun2=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun2' AND MONTH(tanggal)=6 GROUP BY MONTH(tanggal)");
          $presJul2=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun2' AND MONTH(tanggal)=7 GROUP BY MONTH(tanggal)");
          $presAgu2=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun2' AND MONTH(tanggal)=8 GROUP BY MONTH(tanggal)");
          $presSep2=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun2' AND MONTH(tanggal)=9 GROUP BY MONTH(tanggal)");
          $presOkt2=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun2' AND MONTH(tanggal)=10 GROUP BY MONTH(tanggal)");
          $presNov2=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun2' AND MONTH(tanggal)=11 GROUP BY MONTH(tanggal)");
          $presDes2=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun2' AND MONTH(tanggal)=12 GROUP BY MONTH(tanggal)");

        ?>
        Morris.Bar({
          element: 'grafik_perbaikan2',
          data: [
        ...
        Morris.Bar({
          ...
          resize: true
                ...
                <?php
          $presJan3=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun3' AND MONTH(tanggal)=1 GROUP BY MONTH(tanggal)");
          $presFeb3=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun3' AND MONTH(tanggal)=2 GROUP BY MONTH(tanggal)");
          $presMar3=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun3' AND MONTH(tanggal)=3 GROUP BY MONTH(tanggal)");
          $presApr3=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun3' AND MONTH(tanggal)=4 GROUP BY MONTH(tanggal)");
          $presMei3=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun3' AND MONTH(tanggal)=5 GROUP BY MONTH(tanggal)");
          $presJun3=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun3' AND MONTH(tanggal)=6 GROUP BY MONTH(tanggal)");
          $presJul3=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun3' AND MONTH(tanggal)=7 GROUP BY MONTH(tanggal)");
          $presAgu3=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun3' AND MONTH(tanggal)=8 GROUP BY MONTH(tanggal)");
          $presSep3=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun3' AND MONTH(tanggal)=9 GROUP BY MONTH(tanggal)");
          $presOkt3=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun3' AND MONTH(tanggal)=10 GROUP BY MONTH(tanggal)");
          $presNov3=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun3' AND MONTH(tanggal)=11 GROUP BY MONTH(tanggal)");
          $presDes3=mysqli_query($connect, "SELECT COUNT(id_perbaikan) AS jumlah_data FROM detail_poin WHERE tahun_ajaran='$tahun3' AND MONTH(tanggal)=12 GROUP BY MONTH(tanggal)");

        ?>
        Morris.Bar({
          element: 'grafik_perbaikan3',
          data: [
